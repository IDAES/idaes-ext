...
f22_struct memo2_isothermal_compressibility_liq_tp(uint comp, double h, double p);
f22_struct memo2_log_fugacity_coefficient_liq_tp(uint comp, double h, double p);
...
f22_struct memo2_isothermal_compressibility_vap_tp(uint comp, double h, double p);
f22_struct memo2_log_fugacity_coefficient_vap_tp(uint comp, double h, double p);
