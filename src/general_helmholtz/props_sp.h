...
f22_struct memo2_isothermal_compressibility_sp(uint comp, double h, double p);
f22_struct memo2_log_fugacity_coefficient_sp(uint comp, double h, double p);
...
f22_struct memo2_isothermal_compressibility_vap_sp(uint comp, double h, double p);
f22_struct memo2_log_fugacity_coefficient_vap_sp(uint comp, double h, double p);
...
f22_struct memo2_isothermal_compressibility_liq_sp(uint comp, double h, double p);
f22_struct memo2_log_fugacity_coefficient_liq_sp(uint comp, double h, double p);
